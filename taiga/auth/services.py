...
@tx.atomic
def public_register(push_id:str, username:str, password:str, email:str, full_name:str):
    """
...
@tx.atomic
def private_register_for_new_user(push_id:str, token:str, username:str, email:str,
