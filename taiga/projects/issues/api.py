...
import taiga.base.notifications.issue_notifications as issue_push_settings
...
class IssueViewSet(OCCResourceMixin, VotedResourceMixin, HistoryResourceMixin, WatchedResourceMixin,
    ...
    #  this also works for edit case
    def post_save(self, obj, created=False):
        issue_push_settings.enable_notifications_on_high_priority_issues(obj.project_id)
