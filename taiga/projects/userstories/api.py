...
import taiga.base.notifications.user_story_notifications as us_push_settings
...
class UserStoryViewSet(OCCResourceMixin, VotedResourceMixin, HistoryResourceMixin, WatchedResourceMixin,
    ...
    def create(self, *args, **kwargs):
        ...
        project_id = response.data.get("project", 0)
        owner_id = response.data.get("owner_extra_info").get("id")

        us_push_settings.notificate_after_creating(project_id, owner_id)
