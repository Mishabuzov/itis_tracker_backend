...
import uuid
import taiga.base.notifications.project_notifications as project_notifications_settings
...
class ProjectViewSet(LikedResourceMixin, HistoryResourceMixin,
    ...
    def leave(self, request, pk=None):
        ...
        # Notificate manager about leaving
        from taiga.users.models import User
        user = User.objects.filter(id=request.user.id).first()
        project_notifications_settings.notificate_after_leaving(user, project)
        return response.Ok()
...
class MembershipViewSet(BlockedByProjectMixin, ModelCrudViewSet):
    ...
    def post_delete(self, obj):
        project_notifications_settings.notificate_after_deleting_member(obj.user.username, obj.project)
    ...
    def post_save(self, object, created=False):
        ...
        # Notifications after adding new member:
        project_notifications_settings.enable_notifications_after_adding_member(object.user.username, object.project)
