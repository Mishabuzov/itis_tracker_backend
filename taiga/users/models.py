...
class Notification(models.Model):
    id = models.AutoField(auto_created=True, null=False, unique=True, primary_key=True)
    created_date = models.CharField(max_length=200, null=True, blank=True, default=None, verbose_name=_("created date"))
    project_id = models.IntegerField(null=True, default=None, verbose_name=_("project id"))
    notification_type = models.CharField(max_length=200, null=True, blank=True, default=None,
                                         verbose_name=_("notification type"))
    message = models.CharField(max_length=200, null=True, blank=True, default=None, verbose_name=_("message"))

    class Meta:
        db_table = "notifications"

    @classmethod
    def create(cls, created_date, project_id, notification_type, message):
        notification = cls(created_date=created_date, project_id=project_id, notification_type=notification_type,
                           message=message)
        return notification
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    push_id = models.CharField(max_length=200, null=True, blank=True, default=None,
                               verbose_name=_("push id"))
