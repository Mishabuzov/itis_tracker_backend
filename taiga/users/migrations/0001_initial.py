...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        #         ('created_date', models.CharField(max_length=200, null=True, blank=True, default=None, verbose_name='created_date')),
        #         # ('project_id', models.IntegerField(null=True, default=None, verbose_name='project_id')),
        #         ('notification_type', models.CharField(max_length=200, null=True, blank=True, default=None, verbose_name='notification_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('push_id', models.CharField(max_length=200, null=True, blank=True, verbose_name='push_id')),
            ],
            options={
